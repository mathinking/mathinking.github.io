...
Dispone de clientes ligeros para diferentes lenguajes de programación como C#, Java, C/C++ o Python. Pero lo más interesante bajo mi punto de vista es el poder invocar a las funciones mediante una API RESTful a traves de _payloads_ en JSON para manejar la entrada y la salida. 
...
Sin lugar a dudas, creo que la mayor ventaja de MATLAB para el desarrollo de proyectos en _Deep Learning_ viene dado por su flujo de trabajo:
